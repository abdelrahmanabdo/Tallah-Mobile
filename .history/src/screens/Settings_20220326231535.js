    ...
    <ScrollView style={style.container}>
      ...
      <Animatable.View animation={'slideInRight'}  style={style.itemContainer}>
        ...
        <Switch 
          ...
          ios_backgroundColor={data.show_working_hours ? "#FFF" : "#FFF"}
          trackColor={{ false: "#707070", true: "#D4AF37" }}
          thumbColor={'#FFF'}
          onValueChange ={(isOn) => setData({ ...data, show_working_hours: isOn})}
        />
      </Animatable.View>
      <Animatable.View animation={'slideInRight'}  style={style.itemContainer}>
        <Text style={style.title}>
        ...
        <Switch 
          ...
          thumbColor={'#FFF'}
          thumbColor={data.show_in_stylists ? "#f4f3f4" : "#f5dd4b"}
          onValueChange ={(isOn) => setData({ ...data, show_in_stylists: isOn})}
        />
      </Animatable.View>
      <View style={style.itemContainer}>
        <Text style={style.headerText}>
      ...
      <Animatable.View animation={'slideInRight'}  style={style.itemContainer}>
        ...
        <Switch 
          ...
          ios_backgroundColor={'#D4AF37'}
          trackColor={{ false: "#012647", true: "#012647" }}
          thumbColor={data.send_reservations ? "#f4f3f4" : "#f5dd4b"}
          onValueChange ={(isOn) => setData({ ...data, send_reservations: isOn})}
        />
      </Animatable.View>
      <Animatable.View animation={'slideInRight'}  style={style.itemContainer}>
        <Text style={style.title}>
        ...
        <Switch 
          ...
          ios_backgroundColor={'#D4AF37'}
          trackColor={{ false: "#012647", true: "#012647" }}
          thumbColor={data.send_before_reservations ? "#f4f3f4" : "#f5dd4b"}
          onValueChange ={(isOn) => setData({ ...data, send_before_reservations: isOn})}
        />
      </Animatable.View>
    </ScrollView>
    </SafeAreaView>
